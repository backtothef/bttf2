...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("backtothefuture-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("backtothefuture-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("backtothefuture-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "backtothefuture " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("backtothefuture-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("backtothefuture-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("backtothefuture-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("backtothefuture-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. backtothefuture is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("backtothefuture-start");
